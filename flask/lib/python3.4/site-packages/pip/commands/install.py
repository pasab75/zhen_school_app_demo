...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options, args):
        ...
        if options.allow_external:
            warnings.warn(
                "--allow-external has been business_objects and will be removed in "
        ...
        if options.allow_all_external:
            warnings.warn(
                "--allow-all-external has been business_objects and will be removed "
        ...
        if options.allow_unverified:
            warnings.warn(
                "--allow-unverified has been business_objects and will be removed "
                "in the future. Due to changes in the repository protocol, it "
                "no longer has any effect.",
                RemovedInPip10Warning,
            )
        ...
        if options.download_dir:
            warnings.warn(
                "pip install --download has been business_objects and will be "
